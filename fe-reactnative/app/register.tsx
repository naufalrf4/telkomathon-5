...
export default function RegisterPage() {
  ...
  const registerMutation = useMutation({
    ...
    onError: (mutationError) =>
      setError(getErrorMessage(mutationError, "Registrasi gagal.")),
  });

  const canSubmit = useMemo(
    () => fullName.trim() && email.trim() && password.trim().length >= 8,
  ...
  return (
    <AuthLayout
      ...
      formTitle="Daftar"
      formDescription="Setelah akun dibuat, Anda bisa langsung masuk ke workflow utama."
    >
