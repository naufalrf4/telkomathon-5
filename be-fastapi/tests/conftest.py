...
_ = os.environ.setdefault("SECRET_KEY", "test-secret-key-for-jwt-do-not-use-in-prod")
_ = os.environ.setdefault("SEED_USER_USERNAME", "admin")
_ = os.environ.setdefault("SEED_USER_EMAIL", "admin@mydigilearn.id")
_ = os.environ.setdefault("SEED_USER_PASSWORD", "changeme123")
